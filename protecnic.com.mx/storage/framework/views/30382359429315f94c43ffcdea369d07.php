...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name').' · Soluciones CNC'); ?></title>
    ...
    <style>
        ...
        .hero-bg {
            background:
                ...
                url('<?php echo e(asset('images/hero-bg.jpg')); ?>') center/cover no-repeat,
...
<?php /**PATH D:\02-DEVCIJM\00-Proyectos\protecnic.com.mx\resources\views/public/layouts/app.blade.php ENDPATH**/ ?>