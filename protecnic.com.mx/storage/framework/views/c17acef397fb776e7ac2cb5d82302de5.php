...
<form method="POST" action="<?php echo e(route('technician.reports.store')); ?>" enctype="multipart/form-data" id="reportForm" class="space-y-6">
    <?php echo csrf_field(); ?>
                ...
                <select name="client_id" id="clientSelect" class="w-full px-3 py-2 border rounded-lg">
                    ...
                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c->id); ?>"
                            data-name="<?php echo e($c->name); ?>" data-email="<?php echo e($c->email); ?>"
                            data-phone="<?php echo e($c->phone); ?>" data-company="<?php echo e($c->company); ?>">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="machine_id" class="w-full px-3 py-2 border rounded-lg">
                    ...
                    <?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m->id); ?>"><?php echo e($m->name); ?> (<?php echo e($m->brand?->name); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
            ...
            <div>
                ...
                <select name="product_id" class="w-full px-3 py-2 border rounded-lg">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($p->id); ?>" data-type="<?php echo e($p->product_type); ?>"><?php echo e($p->name); ?> (<?php echo e($p->product_type); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="date" name="service_date" value="<?php echo e(now()->toDateString()); ?>" class="w-full px-3 py-2 border rounded-lg">
            </div>
        </div>
        <div class="mt-4">
    ...
    <div class="flex gap-2">
        ...
        <a href="<?php echo e(route('technician.reports.index')); ?>" class="bg-gray-200 px-6 py-3 rounded">Cancelar</a>
    </div>
</form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\02-DEVCIJM\00-Proyectos\protecnic.com.mx\resources\views/technician/reports/create.blade.php ENDPATH**/ ?>