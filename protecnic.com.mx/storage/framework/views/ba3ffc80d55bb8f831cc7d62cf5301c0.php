...
<section id="contacto" class="relative py-16 bg-cover bg-center"
         style="background-image: linear-gradient(rgba(220,220,220,.9), rgba(220,220,220,.9)), url('<?php echo e(asset('images/contact-bg.jpg')); ?>');">
    ...
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-start">
        ...
        <form action="<?php echo e(route('public.contact.store')); ?>" method="POST"
            ...
            <div class="grid grid-cols-2 gap-3">
                <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="Nombre *" required
                ...
                <input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Apellido *" required
                       class="bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-sm placeholder-white/50 focus:outline-none focus:border-sky-300">
            </div>

            <input type="text" name="company" value="<?php echo e(old('company')); ?>" placeholder="Empresa *" required
            ...
            <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Correo empresarial *" required
                   class="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-sm placeholder-white/50 focus:outline-none focus:border-sky-300">
            ...
            <div class="grid grid-cols-3 gap-3">
                <select name="country_code" required
                    ...
                    <?php $__currentLoopData = $ladas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($code); ?>" class="text-slate-800" <?php if(old('country_code', '+52') === $code): echo 'selected'; endif; ?>><?php echo e($code); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Móvil *" required
            ...
            <div class="grid grid-cols-2 gap-3">
                <select name="country" id="country-select" required onchange="toggleStateField(this.value)"
                    ...
                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($c); ?>" class="text-slate-800" <?php if(old('country') === $c): echo 'selected'; endif; ?>><?php echo e($c); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>

                <select name="state" id="state-select"
                        class="bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-sky-300"
                        style="display: <?php echo e(old('country') === 'México' ? 'block' : 'none'); ?>;">
                    <option value="" class="text-slate-800">Estado de la República *</option>
                    <?php $__currentLoopData = $mxStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($st); ?>" class="text-slate-800" <?php if(old('state') === $st): echo 'selected'; endif; ?>><?php echo e($st); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <textarea name="message" rows="4" required minlength="50"
                      ...
                      class="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-sm placeholder-white/50 focus:outline-none focus:border-sky-300"><?php echo e(old('message')); ?></textarea>
...
<?php /**PATH D:\02-DEVCIJM\00-Proyectos\protecnic.com.mx\resources\views/public/partials/contact-section.blade.php ENDPATH**/ ?>