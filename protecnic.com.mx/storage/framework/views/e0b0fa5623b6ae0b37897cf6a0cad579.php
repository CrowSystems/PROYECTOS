...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow p-8">
    ...
    <table class="w-full text-sm">
        <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <tr class="border-b">
                <td class="py-2 font-medium text-slate-700 w-1/2"><?php echo e($label); ?></td>
                <td class="py-2 <?php echo e($bad ? 'text-red-600 font-bold' : 'text-slate-800'); ?>">
                    <?php echo e($value); ?>
...
<?php /**PATH D:\02-DEVCIJM\00-Proyectos\protecnic.com.mx\resources\views/diagnostic/uploads.blade.php ENDPATH**/ ?>