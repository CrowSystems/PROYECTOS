...
@section('title', 'Consumibles · Protecnic')
...
<section class="relative hero-bg text-white py-20 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 mt-12">
        <h1 class="text-4xl md:text-5xl font-extrabold">Consumibles</h1>
        <p class="text-slate-200 mt-2">Alambres, fluidos y refacciones para tu operación.</p>
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        @else
            <p class="text-center text-slate-500 py-20">Sin consumibles registrados aún.</p>
        @endif
    </div>
</section>
@endsection
